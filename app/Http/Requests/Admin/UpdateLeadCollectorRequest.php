...
class UpdateLeadCollectorRequest extends FormRequest
{
    ...
    {
        $collectorId = $this->route('leadCollector')?->id;

        return [
            'name' => ['required', 'string', 'max:255'],
            'slug' => ['nullable', 'string', 'max:255', 'unique:lead_collectors,slug,'.$collectorId],
