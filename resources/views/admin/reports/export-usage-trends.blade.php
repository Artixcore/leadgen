<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Export usage trends') }}</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase">{{ __('Exports') }}</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($data as $row)
                            <tr>
                                <td class="px-4 py-3 text-sm text-gray-900">{{ $row->period }}</td>
